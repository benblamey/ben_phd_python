...
def do_ch7():
    ...
    t1 = matrix2latex.matrix2latex(
          ch7_table_data, 
          filename='C:/work/docs/LATEX/thesis/images/ch7_table_edge_summary.tex',
    ...
    for featureID in set([row['featureID'] for row in rows]):
        ...
        matplotlib.pyplot.savefig("../output/ch7_gen_features_"+featureID+".png", dpi=600, figsize=(8, 6))
        #savefig("../output/ch7_gen_freqGTevents.eps", dpi=600, figsize=(8, 6))
